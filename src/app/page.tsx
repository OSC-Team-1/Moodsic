...
export default function Home() {
  ...
  //     await playTrack("4PTG3Z6ehGkBFwjybzWkR8", "784c0691c1184a7db103d69f6a676e557e138800");
  //   })();
  //   return () => {};
  // }, []);
      ...
      .then((data) => {
        data.onload = async () => {
          ...
          const response = await ai.models.generateContent({
            ...
            never+gonna+give+you+up Rick+Astley DONT RESPOND WITH MOOD ON SONG TITLE AND ARTIST
